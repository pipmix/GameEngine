...
const std::wstring CV_collisionFileType		= L".rect";
const std::wstring CV_meshFileType			= L".mesh";
...
const std::wstring CV_shaderDir				= L"C:/Shaders/";
const std::wstring CV_baseDir				= L"C:/Box/Box Sync/Data/";